...
const UUID = process.env.UUID || 'e850ced4-3fb6-4f48-a9d1-25128f7d2ad7'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'thunderroc9966';            // 获取节点的订阅路径
